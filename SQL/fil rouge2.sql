...
CREATE TABLE Rubrique(
        ...
        sous_rubrique Varchar (50) references Sous_rubrique(sous_rubrique),
...
CREATE TABLE Produit(
        ...
        Rubrique        Varchar(100) references Rubrique(rubrique),
...
CREATE TABLE fourni(
        ...
        Ref_Fournisseur Int references Produit(Ref_fournisseur),
...
CREATE TABLE gere(
        Id_Commande    Int references Commande(Id_Commande),
        Numero_facture Int references Facturation(Numero_facture),
...
CREATE TABLE Passe(
        Ref_Client  Int references Clients(Ref_Client),
        Id_Commande Int references Commande(Id_Commande),
...
CREATE TABLE Declenche(
        Id_Commande   Int references Commande(Id_Commande),
        Bon_Livraison Int references Livraison(Bon_Livraison),
